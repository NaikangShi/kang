...
# from inplace_abn import InPlaceABN, nn.BatchNorm2d
BatchNorm2d = nn.BatchNorm2d


def INF(B, H, W):
    #inf 无穷数 输出B*W个H*H大小对角为-inf矩阵
...
class ResNet(nn.Module):
    ...
    def forward(self, x, labels=None):
        ...
        x_dsn = nn.Upsample(size=(h, w), mode='bilinear', align_corners=True)(x_dsn)
        outs = [x, x_dsn]
...
if __name__ == '__main__':
    ...
    CCNet = Seg_Model(num_classes=3)              # pretrained_model=r'D:\ChangeDetection\ChangeDetectionCoding\ACFNet\pretrained_model\resnet101-5d3b4d8f.pth'
    input1 = torch.rand([2,3,224,224])
    output1, output2 = CCNet(input1)
